...
- (void)setUpSubviews
{
    ...
    CGFloat itemWidth = (1.0 * self.frame.size.width -24) / _titleArray.count;
    for (int i = 0; i < _titleArray.count; i ++) {
        UIButton * button = [UIButton buttonWithType:UIButtonTypeCustom];
        button.frame = CGRectMake(itemWidth * i +12, 1, itemWidth, self.frame.size.height-2);
...
{
    NSDictionary * dic = @{
                           NSFontAttributeName : [UIFont fontWithName:@"Helvetica-Bold" size:font],
