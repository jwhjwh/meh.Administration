...
#import "VCPositil.h"
@interface VCBuessWeekSummaryPostil ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
...
@implementation VCBuessWeekSummaryPostil
-(void)getHttpData
{
