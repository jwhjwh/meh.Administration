...
#import "VCPositil.h"
@interface VCInsideMonthSummaryPostil ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
    BOOL isEditing;
...
@implementation VCInsideMonthSummaryPostil
-(void)getHttpData
{
