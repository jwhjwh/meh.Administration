...
#import "VCPositil.h"
@interface VCInsideWeekSummaryPostil ()<UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UITextViewDelegate,UIAlertViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCInsideWeekSummaryPostil
