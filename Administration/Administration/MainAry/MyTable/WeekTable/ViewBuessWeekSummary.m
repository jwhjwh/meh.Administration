...
-(void)setUI
{
    ...
    textF5.font = [UIFont systemFontOfSize:12];
    ...
    textF6.font = [UIFont systemFontOfSize:12];
    ...
    jk.font = [UIFont systemFontOfSize:12];
    jk.text = @"家";
    [viewB addSubview:jk];
    ...
    textF7.font = [UIFont systemFontOfSize:12];
    ...
    labelj.text = @"万";
    labelj.font = [UIFont systemFontOfSize:12];
