...
@interface VCBuessWeekSummaryDrafts ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
...
@implementation VCBuessWeekSummaryDrafts
-(void)getHttpData
{
