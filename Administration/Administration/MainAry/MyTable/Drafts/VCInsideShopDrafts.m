...
@interface VCInsideShopDrafts ()<UITextViewDelegate,UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UIAlertViewDelegate,ViewChooseScoreDelegate,ViewChooseEditDelegate>
{
    NSArray *arrayTitle;
...
@implementation VCInsideShopDrafts
