...
@interface VCArtWeekSummaryDrafts ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
    BOOL isEditing;
    BOOL isSave;
...
@implementation VCArtWeekSummaryDrafts
