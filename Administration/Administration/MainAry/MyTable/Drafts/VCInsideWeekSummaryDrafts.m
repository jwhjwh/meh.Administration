...
@interface VCInsideWeekSummaryDrafts ()<UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UITextViewDelegate,UIAlertViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCInsideWeekSummaryDrafts
