...
#import "VCPositil.h"
@interface VCInsideWeekSummarySubmited ()<UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UITextViewDelegate,UIAlertViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCInsideWeekSummarySubmited
