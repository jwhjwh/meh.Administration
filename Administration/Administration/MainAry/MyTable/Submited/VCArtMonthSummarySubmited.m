...
#import "VCPositil.h"
@interface VCArtMonthSummarySubmited ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCArtMonthSummarySubmited
...
-(void)submitData:(NSString *)hint
{
    ...
    NSDictionary *dict = @{@"appkey":appKeyStr,
                           ...
                           @"Months":[NSString stringWithFormat:@"%@-15",self.artMonthSummary.buttonDate.titleLabel.text],
