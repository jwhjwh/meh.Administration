...
#import "VCPositil.h"
@interface VCArtWeekSummarySubmited ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
    BOOL isEditing;
    BOOL isSave;
...
@implementation VCArtWeekSummarySubmited
