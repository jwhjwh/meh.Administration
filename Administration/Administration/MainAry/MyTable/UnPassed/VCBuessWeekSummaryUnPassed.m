...
#import "VCPositil.h"
@interface VCBuessWeekSummaryUnPassed ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
...
@implementation VCBuessWeekSummaryUnPassed
-(void)getHttpData
{
