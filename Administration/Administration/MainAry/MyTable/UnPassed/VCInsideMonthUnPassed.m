...
#import "VCPositil.h"
@interface VCInsideMonthUnPassed ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCInsideMonthUnPassed
