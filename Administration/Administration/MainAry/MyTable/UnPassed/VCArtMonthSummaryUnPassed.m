...
@interface VCArtMonthSummaryUnPassed ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
...
@implementation VCArtMonthSummaryUnPassed
