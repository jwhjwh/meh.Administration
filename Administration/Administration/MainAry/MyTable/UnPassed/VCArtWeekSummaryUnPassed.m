...
@interface VCArtWeekSummaryUnPassed ()<UITableViewDelegate,UITableViewDataSource,UITextViewDelegate,ViewChooseEditDelegate>
{
    BOOL isBack;
    BOOL isEditing;
    BOOL isSave;
...
@implementation VCArtWeekSummaryUnPassed
