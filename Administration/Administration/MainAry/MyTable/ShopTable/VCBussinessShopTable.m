...
@interface VCBussinessShopTable ()<UITextViewDelegate,UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UIAlertViewDelegate,ViewChooseScoreDelegate>
...
@implementation VCBussinessShopTable
#pragma -mark custem
-(void)setUI
{
