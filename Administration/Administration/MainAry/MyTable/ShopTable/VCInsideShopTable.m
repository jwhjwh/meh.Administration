...
@interface VCInsideShopTable ()<UITextViewDelegate,UITableViewDelegate,UITableViewDataSource,ViewDatePickerDelegate,UIAlertViewDelegate,ViewChooseScoreDelegate>
{
    NSArray *arrayTitle;
...
@implementation VCInsideShopTable
