...
@interface OneStoreinfor ()<UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,retain)UITableView *tableView;
@property (nonatomic ,retain)NSArray *nameArrs;

@end

@implementation OneStoreinfor
...
- (void)viewDidLoad {
    ...
    _nameArrs = @[@[@"客户资料"],@[@"目标客户确立表"],@[@"意向客户表"],@[@"陌拜记录表"]];
    [self addViewremind];
}
-(void)addViewremind{
