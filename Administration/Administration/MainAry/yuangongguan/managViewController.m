...
@interface managViewController ()<YUFoldingSectionHeaderDelegate,UITableViewDelegate,UITableViewDataSource>
...
@property (strong,nonatomic) NSMutableArray *jingNameAry;
@end

@implementation managViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self.navigationController pushViewController:guangliVC animated:YES];
}
...
-(void)loadData{
    ...
    [ZXDNetworking GET:uStr parameters:dic success:^(id responseObject) {
        ...
        _jingNameAry=[NSMutableArray array];
        ...
        if ([[responseObject valueForKey:@"status"]isEqualToString:@"0000"]) {
            ...
            _InterNameAry=[NSMutableArray arrayWithObjects:_shiNameAry,_neiNameAry,_wuNameAry,_yeNameAry,_pinNameAry,_xingNameAry,_jingNameAry,nil];
            _array=@[@"市场人员",@"内勤人员",@"物流人员",@"业务人员",@"品牌经理",@"行政管理",@"业务经理"];
