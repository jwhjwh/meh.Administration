...
#import "branModel.h"
@interface businController ()<UITableViewDelegate,UITableViewDataSource,UIAlertViewDelegate>
...
@implementation businController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.title=_tlile;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.image.image=[UIImage imageNamed:@"icow"];
...
-(void)getNetworkData{
    ...
    NSDictionary *dic=@{@"appkey":apKeyStr,@"usersid":[USER_DEFAULTS  objectForKey:@"userid"],@"Num":@"2",@"CompanyInfoId":compid};
...
-(void)addGetNetworkData{
    ...
    NSString *compid=[NSString stringWithFormat:@"%@",[USER_DEFAULTS objectForKey:@"companyinfoid"]];
    NSString *apKeyStr=[ZXDNetworking encryptStringWithMD5:apKey];
    NSDictionary *dic=@{@"appkey":apKeyStr,@"usersid":[USER_DEFAULTS  objectForKey:@"userid"],@"Num":@"2",@"CompanyInfoId":compid,@"LevelName":_nameStr};
    [ZXDNetworking GET:uStr parameters:dic success:^(id responseObject) {
        if ([[responseObject valueForKey:@"status"]isEqualToString:@"0000"]) {
            branModel *model=[[branModel alloc]init];
...
-(void)removedGetNetworkData:(NSIndexPath*)path{
    ...
    NSString *apKeyStr=[ZXDNetworking encryptStringWithMD5:apKey];
    NSDictionary *dic=@{@"appkey":apKeyStr,@"usersid":[USER_DEFAULTS  objectForKey:@"userid"],@"Num":@"2",@"CompanyInfoId":compid,@"id":model.ID};
    [ZXDNetworking GET:uStr parameters:dic success:^(id responseObject) {
        if ([[responseObject valueForKey:@"status"]isEqualToString:@"0000"]) {
...
-(void)updatePosition:(NSIndexPath*)IndexPath{
    ...
    NSString *apKeyStr=[ZXDNetworking encryptStringWithMD5:apKey];
    NSDictionary *dic=@{@"appkey":apKeyStr,@"usersid":[USER_DEFAULTS  objectForKey:@"userid"],@"Num":@"2",@"CompanyInfoId":compid,@"id":model.ID,@"LevelName":_nameStr};
    [ZXDNetworking GET:uStr parameters:dic success:^(id responseObject) {
        if ([[responseObject valueForKey:@"status"]isEqualToString:@"0000"]) {
