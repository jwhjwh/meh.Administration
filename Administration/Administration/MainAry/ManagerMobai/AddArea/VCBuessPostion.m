...
@interface VCBuessPostion ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation VCBuessPostion

#pragma -mark cutem

-(void)getHttpData
{
    NSString *urlStr =[NSString stringWithFormat:@"%@shop/selectRoleSetNum.action",KURLHeader];
...
{
    NSDictionary *dict = self.arrayData[indexPath.row];
    VCPostionPerson *vc = [[VCPostionPerson alloc]init];
