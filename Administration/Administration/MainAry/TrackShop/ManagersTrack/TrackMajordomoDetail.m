...
@interface TrackMajordomoDetail ()<ViewDatePickerDelegate,UITableViewDelegate,UITableViewDataSource,UITextViewDelegate>
...
@implementation TrackMajordomoDetail
...
-(void)getHttpData
{
    ...
    [ZXDNetworking GET:urlStr parameters:dict success:^(id responseObject) {
        ...
        if ([code isEqualToString:@"0000"]) {
            ...
            self.string1 = dictTrack[@"usersName"];
            self.string2 = dictTrack[@"executivebrand"];
            self.string3 = dictTrack[@"timePlanning"];
            self.string4 = dictTrack[@"expectedTime"];
            self.string5 = dictTrack[@"question"];
            self.string6 = dictTrack[@"performance"];
            self.string7 = dictTrack[@"special"];
            self.string8 = dictTrack[@"summary"];
            ...
            self.startDate = [dictTrack[@"starttime"]substringToIndex:10];
            self.endDate = [dictTrack[@"endtime"]substringToIndex:10];
            
            [self.buttonStart setTitle:self.startDate forState:UIControlStateNormal];
            [self.buttonEnd setTitle:self.endDate forState:UIControlStateNormal];
            [self.tableView reloadData];
            return ;
        }
