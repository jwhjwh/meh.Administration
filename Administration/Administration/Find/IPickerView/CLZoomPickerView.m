            ...
            bottomRowCount:(NSUInteger)bottomRowCount
{
    ...
    _tipebackView =[[UIView alloc]initWithFrame:CGRectMake(30, (self.frame.size.height-150)/2, self.frame.size.width-60, 290)];
    ...
    [_tipebackView addSubview:_button];
...
- (void)layoutSubviews
{
    ...
    CGRect frame = CGRectMake(_tipebackView.bounds.origin.x,
                              40,
                              _tipebackView.bounds.size.width,
    ...
    if(self.tableView == nil)
    {
        ...
        [_tipebackView addSubview:self.tableView];
