...
-(void)logIng{
    ...
    [_PassText setValue:[UIColor lightGrayColor] forKeyPath:@"_placeholderLabel.textColor"];
    ...
    [_valiText setValue:[UIColor lightGrayColor] forKeyPath:@"_placeholderLabel.textColor"];
