...
@property (strong,nonatomic) NSString *flag;  //阴历阳历生日的标识
@property (strong,nonatomic) NSString *solarBirthday;  //出生年月
@property (strong,nonatomic) NSString *lunarBirthday;//阴历生日
